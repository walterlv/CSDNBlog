...
![入口模块句柄](https://blog.walterlv.com/static/posts/2020-04-18-10-55-00.png)
...
![找不到指定的模块](https://blog.walterlv.com/static/posts/2020-04-10-15-46-43.png)
...
- [通过子类化窗口（SubClass）来为现有的某个窗口添加新的窗口处理程序（或者叫钩子，Hook） - walterlv](https://blog.walterlv.com/post/hook-a-window-by-sub-classing-it.html)
